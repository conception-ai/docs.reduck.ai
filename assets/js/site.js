// The behaviour the chrome needs on every page: the burger's sheet, and the copy button — the one
// a fenced block carries, and the one a page carries for its markdown.
(() => {
	"use strict";
